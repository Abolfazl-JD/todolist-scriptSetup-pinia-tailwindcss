        ...
        <div class="todolist-items w-full bg-white dark:bg-slate-800 rounded-md shadow shadow-gray-400">
          ...
          <div class="flex justify-between py-5 px-3 group border-b border-b-gray-400 dark:border-b-gray-700">
            <div class="flex items-center gap-5">
              <div class="w-6 h-6 p-3 rounded-full border border-solid flex items-center justify-center bg-gradient-to-r from-[#4fc6e4] to-[#9342bb]">
                <div class="flex flex-col justify-center items-center h-full  text-white rounded-full p-[10px] bg-gradient-to-r from-[#4fc6e4] to-[#9342bb]">
                  <svg 
                    xmlns="http://www.w3.org/2000/svg" 
